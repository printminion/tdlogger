...
#
# However, when we do this, we also import `tdlogger/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'tdlogger_cli = messages.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'tdlogger_gui = tdlogger.gui:entry_point'
        # ]
    }
)
